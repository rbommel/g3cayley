...
AllHyperTypes := [
    "[3]",  "[2n]", "[2e]", "[1nn]", "[1=1]", "[2m]", "[1ne]", "[1ee]", "[0nnn]", "[1=0n]", "[0nne]", "[1nm]", "[1=0e]", "[1me]", "[0nee]", "[0----0]", "[0n=0n]", "[0nnm]", "[Z=1]", "[1=0m]", "[0n=0e]", "[1mm]", "[0nme]", "[0e=0e]", "[Z=0n]", "[0n=0m]", "[0nmm]", "[Z=0e]", "[0m=0e]", "[Z=Z]", "[Z=0m]", "[0m=0m]"
    ];
...
ExampleDiagrams := [*
    ...
    [* <"TB", {1,2,3}>, <"TCu",{}> *],
    [* <"Tw", {1,2}>, <"Tw", {3,4}>, <"TCu",{}> *],
    [* <"CC", {{1,2,3,4},{5,6,7,8}}>, <"TCu",{}> *],
    [* <"Tw", {1,2}>, <"TB", {1,2,3}>, <"TCu",{}> *],
    [* <"Tw", {1,2}>, <"TB", {3,4,5}>, <"TCu",{}> *],
    [* <"TB", {1,2,3}>, <"TB", {4,5,6}>, <"TCu",{}> *],
    [* <"Tw", {1,2}>, <"Tw", {3,4}>, <"Tw", {5,6}>, <"TCu",{}> *],
    [* <"Tw", {1,2}>, <"CC", {{1,2,3,4},{5,6,7,8}}>, <"TCu",{}> *],
    [* <"Tw", {1,2}>, <"Tw", {3,4}>, <"TB", {5,6,7}>, <"TCu",{}> *],
    [* <"Tw", {1,2}>, <"Tw", {3,4}>, <"TB", {3,4,5}>, <"TCu",{}> *],
    [* <"TB", {1,2,3}>, <"CC", {{1,2,3,4},{5,6,7,8}}>, <"TCu",{}> *],
    [* <"Tw", {1,2}>, <"TB", {1,2,3}>, <"TB", {4,5,6}>, <"TCu",{}> *],
    [* <"Tw", {7,8}>, <"TB", {1,2,3}>, <"TB", {4,5,6}>, <"TCu",{}> *],
    [* <"Tw", {1,2}>, <"Tw", {3,4}>, <"Tw", {5,6}>, <"Tw", {7,8}>, <"TCu",{}> *],
    [* <"Tw", {1,2}>, <"Tw", {5,6}>, <"CC", {{1,2,3,4},{5,6,7,8}}>, <"TCu",{}> *],
    [* <"Tw", {1,2}>, <"Tw", {3,4}>, <"Tw", {5,6}>, <"TB", {5,6,7}>, <"TCu",{}> *],
    [* <"Tw", {1,2}>, <"Tw", {3,4}>, <"CC", {{1,2,3,4},{5,6,7,8}}>, <"TCu",{}> *],
    [* <"Tw", {1,2}>, <"TB", {1,2,3}>, <"CC", {{1,2,3,4},{5,6,7,8}}>, <"TCu",{}> *],
    [* <"Tw", {5,6}>, <"TB", {1,2,3}>, <"CC", {{1,2,3,4},{5,6,7,8}}>, <"TCu",{}> *],
    [* <"Tw", {1,2}>, <"Tw", {4,5}>, <"TB", {1,2,3}>, <"TB", {4,5,6}>, <"TCu",{}> *],
    [* <"Tw", {1,2}>, <"Tw", {7,8}>, <"TB", {1,2,3}>, <"TB", {4,5,6}>, <"TCu",{}> *],
    [* <"TB", {1,2,3}>, <"TB", {5,6,7}>, <"CC", {{1,2,3,4},{5,6,7,8}}>, <"TCu",{}> *],
    [* <"Tw", {1,2}>, <"Tw", {3,4}>, <"Tw", {5,6}>, <"CC", {{1,2,3,4},{5,6,7,8}}>, <"TCu",{}> *],
    [* <"Tw", {1,2}>, <"Tw", {5,6}>, <"TB", {1,2,3}>, <"CC", {{1,2,3,4},{5,6,7,8}}>, <"TCu",{}> *],
    [* <"Tw", {1,2}>, <"Tw", {4,5}>, <"Tw", {7,8}>, <"TB", {1,2,3}>, <"TB", {4,5,6}>, <"TCu",{}> *],
    [* <"Tw", {1,2}>, <"Tw", {3,4}>, <"TB", {5,6,7}>, <"CC", {{1,2,3,4},{5,6,7,8}}>, <"TCu",{}> *],
    [* <"Tw", {1,2}>, <"TB", {1,2,3}>, <"TB", {5,6,7}>, <"CC", {{1,2,3,4},{5,6,7,8}}>, <"TCu",{}> *],
    [* <"Tw", {1,2}>, <"Tw", {3,4}>, <"Tw", {5,6}>, <"Tw", {7,8}>, <"CC", {{1,2,3,4},{5,6,7,8}}>, <"TCu",{}> *],
    [* <"Tw", {1,2}>, <"Tw", {3,4}>, <"Tw", {5,6}>, <"TB", {5,6,7}>, <"CC", {{1,2,3,4},{5,6,7,8}}>, <"TCu",{}> *],
    [* <"Tw", {1,2}>, <"TB", {1,2,3}>, <"Tw", {5,6}>, <"TB", {5,6,7}>, <"CC", {{1,2,3,4},{5,6,7,8}}>, <"TCu",{}> *]
    *];
