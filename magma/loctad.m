...
intrinsic NormaliseValuationData(v1::ModTupFldElt : S := {1,2,3,4,5}, Permute := false)->ModTupFldElt
	{ Compute the valuation data of the normalised octad. The optional parameter S determines which points of the octad will be at the standard position (default: 1,2,3,4,5). The optional parameter Permute determines whether the points in the octad will be permuted such that the points in S become the first five points. }
	assert(#S eq 5);
